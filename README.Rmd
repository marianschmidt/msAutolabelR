...
The goal of msAutolabelleR is to automate labelling introduced by the sjlabelled package, which provides very helpful functions on labelling dataframes.
